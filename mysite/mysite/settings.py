...
SECRET_KEY = 'django-insecure-6@tcr)7ka4h!od5nxz)xywifba57@lu*7+ewn2dxv*x(-*^7#%'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True


#? not applied when debug mode is on
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True #? Whether to use a Transport Layer Security (TLS) secure connection
#+ EMAIL_USE_SSL # ? Whether to use an implicit TLS secure connection
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL')
#+ EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend' write emails to the console for testing
